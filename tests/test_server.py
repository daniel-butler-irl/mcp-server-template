...
class TestMCPServer:
    ...
    @pytest.mark.asyncio
    async def test_hello_tool_basic(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_hello_tool_with_environment_vars(self) -> None:
        ...
        with patch.dict(
            os.environ,
            {"MCP_GREETING_PREFIX": test_prefix, "MCP_SERVER_NAME": "Test Server"},
        ):
    ...
    @pytest.mark.asyncio
    async def test_hello_tool_empty_name(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_hello_tool_special_characters(self) -> None:
    ...
    def test_server_transport_stdio(self) -> None:
